...
class Email {
  ...
  public static function sendConfirmEmail($obUser) {
    ...
    try {
      ...
      $mail->SMTPAuth = true;
      $mail->Username = 'noreplyecampanhado@gmail.com';
      $mail->Password = getenv('GMAIL_PW');
      $mail->Port     = 587;

      $mail->setFrom('noreplyecampanhado@gmail.com');
      $mail->addAddress($obUser->email);
      $mail->addReplyTo('noreplyecampanhado@gmail.com', 'Informação');

      $mail->isHTML(true);
      $mail->Subject = 'Confirme seu E-mail';
      $mail->Body    = '<h1>Obrigado por usar o E-campanhado</h1> <br> Confirme seu E-mail no link a seguir: ' . $link;
      $mail->AltBody = 'Obrigado por usar o E-campanhado Confirme seu E-mail no link a seguir: ' . $link;
  ...
  public static function sendChangeEmail(string $email) {
    ...
    try {
      ...
      $mail->Body    = '<h1>Obrigado por usar o Ecampanhado</h1> <br/> Confirme seu novo E-mail no link a seguir:' . $link;
      $mail->AltBody = 'Obrigado por usar o Ecampanhado Confirme seu novo E-mail no link a seguir: ' . $link;
  ...
  public static function sendEmail($nome, $email, $mensagem) {
    ...
    try {
      ...
      $mail->setFrom($email);
      $mail->addAddress('noreplyecampanhado@gmail.com');
